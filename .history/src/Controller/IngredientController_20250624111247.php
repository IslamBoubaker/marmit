...
class IngredientController extends AbstractController {
    ...
    #[Route('/ingredient/{id}/modifier', name: 'app_ingredient_edit', methods: ['GET', 'POST'])]
    ...
    public function edit(IngredientRepository $ingredientRepository, int $id, Request $request): Response
    {
        $ingredient = $ingredientRepository->findOne("id"=>$id);
        if (!$ingredient) {
